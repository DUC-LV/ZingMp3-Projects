...
class Playlists(admin.ModelAdmin):
    list_display = ["title", "thumbnail", "isoffical", "is_indie", "release_date", "sort_description", "pr",
                    "artist_names", "play_item_mode", "sub_type", "thumbnail_m", "is_shuffle", "is_private", "user_name"
                    , "is_album", "text_type", "is_single", "created_at"]
